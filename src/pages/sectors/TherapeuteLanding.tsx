...
const TherapeuteLanding = () => {
  const sectorData = sectorsData.therapeute;
  useAOS();
  
  useEffect(() => {
    // Track page view for therapeute landing
    console.log('Therapeute landing page loaded');
  }, []);
    ...
    <>
      ...
      <div className="min-h-screen">
        ...
        <div data-aos="fade-up">
          <WebsiteForm defaultProfession="sante" />
        </div>
...
export default TherapeuteLanding;
