...
const ElectricienLanding = () => {
  const sectorData = sectorsData.electricien;
  useAOS();
  
  useEffect(() => {
    // Track page view for electricien landing
    console.log('Electricien landing page loaded');
  }, []);
...
export default ElectricienLanding;
